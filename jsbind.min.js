...
(function(b){function g(){this.root=new h;this.c={"":this.root};this.b={};this.a=!1}function h(){this.g=[];this.children={}}function B(a){this.value=a}function C(a){this.textContent=a}function D(a,b,e){function c(c,d){var k=f.get(d);if(!k){var q=new g,n=a.content.cloneNode(!0);w(n,q,e);k={f:q,m:n,j:[].concat(A(n.childNodes))};f.set(d,k);b.parentNode.insertBefore(n,b);e.add(q)}k.f.update("$",c)}function d(a){var c=f.get(a);c&&(f.delete(a),e.delete(c.f),c.f.update("$",null),c.j.forEach(function(a){return a.remove()}))}
...
this.c[f]||new h:c.i(d),d=this.c[f];if(void 0!==d&&d!==c)throw Error("unexpected node in flat map: `"+f+"`");this.c[f]=c}c.g.push(b)};g.prototype.h=function(a,b){this.add(a,b);a in this.b||(this.b[a]=[]);this.b[a].push(b);this.a=null};g.prototype.update=function(a,b){var e=this.c[a];if(e)for(a=[{node:e,value:b}];a.length;){var c=a.shift(),e=c.node,c=c.value;e.l(c);for(var d in e.children)a.push({node:e.children[d],value:null===c||void 0===c?void 0:c[d]})}else{if(null===this.a)d="^("+Object.keys(this.b).map(function(a){return a.replace(".",
"\\.")}).join("|")+")\\.(\\w+)(?:\\.(.*)|)$",this.a=new RegExp(d);else if(!this.a)return;if(d=this.a.exec(a)){a=d[1];var f=d[2];this.b[a].forEach(function(a){return a(b,f)})}}};var l=new RegExp(/{{(.*?)}}/g);b.JSBind=function(a,b){function e(a,b){c.forEach(function(c){return c.update(a,b)})}a=E(a);var c=new Set,d=new g;w(a,d,c);c.add(d);e("",b);return{root:a,update:e}}})(window);
